...
$var_arrays = array('traveladvisor_var_fonts_subsets');
$fonts_array_global_vars = TRAVELADVISOR_VAR_GLOBALS()->globalizing($var_arrays);
extract($fonts_array_global_vars);
if (!function_exists('traveladvisor_var_get_google_init_arrays')) {

    function traveladvisor_var_get_google_init_arrays() {
        ...
        update_option('traveladvisor_var_font_list', $font_list_init);
        update_option('traveladvisor_var_font_attribute', $font_atts_int);
    }

}
$traveladvisor_var_fonts_subsets = array(
