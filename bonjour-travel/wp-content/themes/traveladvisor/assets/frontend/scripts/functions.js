...
function traveladvisor_map_select_style(style) {
 ...
 window.onload = function(e)  {
    var count = jQuery('.woocommerce-product-details__short-description').length;
    if (count > 0) {
        var h2 = jQuery('.woocommerce-product-details__short-description').prev('h2');
        jQuery('.woocommerce-product-details__short-description').prev('h2').remove();
        jQuery('.woocommerce-product-details__short-description').prev('div').before(h2)
    }
}
