    ...
    class traveladvisor_var_form_fields {
        ...
        public function traveladvisor_var_form_text_render($params = '') {
            ...
            if (isset($return) && $return == true) {
                return force_balance_tags($traveladvisor_var_output);
            } else {
        ...
        public function traveladvisor_var_form_radio_render($params = '') {
            ...
            if (isset($cus_field) && $cus_field == true) {
                $html_name = ' name="' . esc_html($prefix) . 'cus_field[' . sanitize_html_class($id) . ']"';
            } else {
                $html_name = ' name="' . esc_html($prefix) . sanitize_html_class($id) . '"';
            }

            if (isset($array) && $array == true) {
                $html_id = ' id="' . esc_html($prefix) . sanitize_html_class($id) . $traveladvisor_var_rand_id . '"';
                $html_name = ' name="' . esc_html($prefix) . sanitize_html_class($id) . '_array[]"';
            }
            ...
            if (isset($cust_name)) {
                $html_name = ' name="' . esc_html($cust_name) . '"';
            }
        ...
        public function traveladvisor_var_form_textarea_render($params = '') {
            ...
            $traveladvisor_var_output .= $traveladvisor_var_before;
            $traveladvisor_var_output .= ' <textarea' . esc_html($traveladvisor_var_required) . ' ' . esc_html($extra_atributes) . ' ' . $html_id . $html_name . $traveladvisor_var_classes . '>' . $value . '</textarea>';
            $traveladvisor_var_output .= $traveladvisor_var_after;
        ...
        public function traveladvisor_var_form_select_render($params = '') {
            ...
            $traveladvisor_var_output = '';
$force_std=  isset($force_std)?$force_std:'';
            if (isset($prefix_on)) {
                $prefix_enable = $prefix_on;
            }
        ...
        public function traveladvisor_var_form_checkbox_render($params = '') {
            ...
            if (isset($simple) && $simple == true) {
                ...
                $traveladvisor_var_output .= '<input type="checkbox" ' . $traveladvisor_var_classes . ' ' . $btn_name . $checked . ' ' . $extra_atributes . ' />';
        ...
        public function traveladvisor_var_media_url($params = '') {
            ...
            $traveladvisor_var_output .= '<input type="button" ' . $html_id_btn . $html_name . ' class="uploadfile left" value="' . __('Browse', 'ca-traveladvisor') . '"/>';
            $traveladvisor_var_output .= '</label>';
        ...
        public function traveladvisor_var_form_fileupload_render($params = '') {
            ...
            $traveladvisor_var_output .= '<label' . $display_btn . ' class="browse-icon"><input' . $btn_name . 'type="button" class="cs-uploadMedia left" value=' . __("Browse", "cs-traveladvisor") . ' /></label>';
