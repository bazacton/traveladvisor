<?php
$var_array = array('wpdb', 'a', 'traveladvisor_var_tour_item_per_page', 'traveladvisor_custom_fields_array', 'wp_traveladvisor', 'traveladvisor_var_wp_traveladvisor_core', 'traveladvisor_var_tour_elements', 'post', 'traveladvisor_var_form_fields', 'traveladvisor_var_html_fields', 's_title_search', 'traveladvisor_inventories_counter', 'traveladvisor_var_tour_filteration');
...
if (isset($inventory_ajax_view) && $inventory_ajax_view != '') {
    ...
    if ($a['traveladvisor_inventory_view'] == 'grid') {
        $inv_class = "grid";
...
//global $traveladvisor_var_tour_elements;
...
if ($a['traveladvisor_var_tour_filteration'] == 'yes') {
    echo "<div class='page-content col-lg-9 col-md-9 col-sm-12 col-xs-12'>";
} else {
    echo "<div class='page-content col-lg-12 col-md-9 col-sm-12 col-xs-12'>";
}
?>
<div class="row">
    ...
    <div class="col-lg-12">
        <div class="cs-list-short"> <strong><?php echo traveladvisor_var_theme_text_srt('traveladvisor_var_sort_by'); ?></strong>
            <ul class="cs-listing-short-by">
                ...
                ?>><span ><?php echo traveladvisor_var_theme_text_srt('traveladvisor_var_relevance'); ?></span><a href="<?php echo site_url('tour-listing'); ?>"></a> </li>
                    <?php
    ...
    $traveladvisor_metass = array();
    $traveladvisor_labelss = array();
    ...
    if (is_array($traveladvisor_total_fields) && !empty($traveladvisor_total_fields)) {
        $traveladvisor_counting = count($traveladvisor_total_fields) - 1;
    } else {
        $traveladvisor_counting = 0;
    }
    for ($traveladvisor_a = 0; $traveladvisor_a <= $traveladvisor_counting; $traveladvisor_a ++) {
        ...
        switch ($traveladvisor_get_field) {
            case "textarea":
                $traveladvisor_labelss = isset($traveladvisor_var_theme_options["traveladvisor_cus_field_$traveladvisor_get_field"]["label"][$traveladvisor_textarea_num]) ? $traveladvisor_var_theme_options["traveladvisor_cus_field_$traveladvisor_get_field"]["label"][$traveladvisor_textarea_num] : '';
                $traveladvisor_metass = isset($traveladvisor_var_theme_options["traveladvisor_cus_field_$traveladvisor_get_field"]["meta_key"][$traveladvisor_textarea_num]) ? $traveladvisor_var_theme_options["traveladvisor_cus_field_$traveladvisor_get_field"]["meta_key"][$traveladvisor_textarea_num] : '';
                $traveladvisor_textarea_num ++;
                break;
            case "date":
                $traveladvisor_labelss = isset($traveladvisor_var_theme_options["traveladvisor_cus_field_$traveladvisor_get_field"]["label"][$traveladvisor_date_num]) ? $traveladvisor_var_theme_options["traveladvisor_cus_field_$traveladvisor_get_field"]["label"][$traveladvisor_date_num] : '';
                $traveladvisor_metass = isset($traveladvisor_var_theme_options["traveladvisor_cus_field_$traveladvisor_get_field"]["meta_key"][$traveladvisor_date_num]) ? $traveladvisor_var_theme_options["traveladvisor_cus_field_$traveladvisor_get_field"]["meta_key"][$traveladvisor_date_num] : '';
                $traveladvisor_date_num ++;
                break;
            case "text":
                $traveladvisor_labelss = isset($traveladvisor_var_theme_options["traveladvisor_cus_field_$traveladvisor_get_field"]["label"][$traveladvisor_text_num]) ? $traveladvisor_var_theme_options["traveladvisor_cus_field_$traveladvisor_get_field"]["label"][$traveladvisor_text_num] : '';
                $traveladvisor_metass = isset($traveladvisor_var_theme_options["traveladvisor_cus_field_$traveladvisor_get_field"]["meta_key"][$traveladvisor_text_num]) ? $traveladvisor_var_theme_options["traveladvisor_cus_field_$traveladvisor_get_field"]["meta_key"][$traveladvisor_text_num] : '';
                $traveladvisor_text_num ++;
                break;
            case "email":
                $traveladvisor_labelss = isset($traveladvisor_var_theme_options["traveladvisor_cus_field_$traveladvisor_get_field"]["label"][$traveladvisor_email_num]) ? $traveladvisor_var_theme_options["traveladvisor_cus_field_$traveladvisor_get_field"]["label"][$traveladvisor_email_num] : '';
                $traveladvisor_metass = isset($traveladvisor_var_theme_options["traveladvisor_cus_field_$traveladvisor_get_field"]["meta_key"][$traveladvisor_email_num]) ? $traveladvisor_var_theme_options["traveladvisor_cus_field_$traveladvisor_get_field"]["meta_key"][$traveladvisor_email_num] : '';
                $traveladvisor_email_num ++;
                break;
            case "range":
                $traveladvisor_labelss = isset($traveladvisor_var_theme_options["traveladvisor_cus_field_$traveladvisor_get_field"]["label"][$traveladvisor_range_num]) ? $traveladvisor_var_theme_options["traveladvisor_cus_field_$traveladvisor_get_field"]["label"][$traveladvisor_range_num] : '';
                $traveladvisor_metass = isset($traveladvisor_var_theme_options["traveladvisor_cus_field_$traveladvisor_get_field"]["meta_key"][$traveladvisor_range_num]) ? $traveladvisor_var_theme_options["traveladvisor_cus_field_$traveladvisor_get_field"]["meta_key"][$traveladvisor_range_num] : '';
                $traveladvisor_range_num ++;
                break;
            case "url":
                $traveladvisor_labelss = isset($traveladvisor_var_theme_options["traveladvisor_cus_field_$traveladvisor_get_field"]["label"][$traveladvisor_url_num]) ? $traveladvisor_var_theme_options["traveladvisor_cus_field_$traveladvisor_get_field"]["label"][$traveladvisor_url_num] : '';
                $traveladvisor_metass = isset($traveladvisor_var_theme_options["traveladvisor_cus_field_$traveladvisor_get_field"]["meta_key"][$traveladvisor_url_num]) ? $traveladvisor_var_theme_options["traveladvisor_cus_field_$traveladvisor_get_field"]["meta_key"][$traveladvisor_url_num] : '';
                $traveladvisor_url_num ++;
                break;
            case "dropdown":
                $traveladvisor_labelss = isset($traveladvisor_var_theme_options["traveladvisor_cus_field_$traveladvisor_get_field"]["label"][$traveladvisor_dropdown]) ? $traveladvisor_var_theme_options["traveladvisor_cus_field_$traveladvisor_get_field"]["label"][$traveladvisor_dropdown] : '';
                $traveladvisor_metass = isset($traveladvisor_var_theme_options["traveladvisor_cus_field_$traveladvisor_get_field"]["meta_key"][$traveladvisor_dropdown]) ? $traveladvisor_var_theme_options["traveladvisor_cus_field_$traveladvisor_get_field"]["meta_key"][$traveladvisor_dropdown] : '';
                $traveladvisor_dropdown ++;
                break;
            default :

                $traveladvisor_labelss = isset($traveladvisor_var_theme_options["traveladvisor_cus_field_$traveladvisor_get_field"]["label"][$traveladvisor_dropdown][$traveladvisor_none_num]) ? $traveladvisor_var_theme_options["traveladvisor_cus_field_$traveladvisor_get_field"]["label"][$traveladvisor_dropdown][$traveladvisor_none_num] : '';
                $traveladvisor_metass = isset($traveladvisor_var_theme_options["traveladvisor_cus_field_$traveladvisor_get_field"]["meta_key"][$traveladvisor_dropdown][$traveladvisor_none_num]) ? $traveladvisor_var_theme_options["traveladvisor_cus_field_$traveladvisor_get_field"]["meta_key"][$traveladvisor_dropdown][$traveladvisor_none_num] : '';
...
//date
    ...
    $cs_id = 0;
    $traveladvisor_meta_values = array();
    $traveladvisor_metass_values = array();
    while ($traveladvisor_var_tours_post_data->have_posts()):$traveladvisor_var_tours_post_data->the_post();
        ...
        $traveladvisor_var_tour_starting_date = get_post_meta($id, 'traveladvisor_var_tour_starting_date', true);
        ...
        $traveladvisor_metass_count = count($traveladvisor_metass) - 1;
        for ($traveladvisor_a = 0; $traveladvisor_a <= $traveladvisor_metass_count; $traveladvisor_a ++) {
            $traveladvisor_values = $traveladvisor_metass[$traveladvisor_a];
            if (is_array($traveladvisor_values)) {
                if (empty($traveladvisor_values)) {
                    $traveladvisor_metass[$traveladvisor_a] = '';
                }
            }
            $traveladvisor_metass_values = get_post_meta($id, "traveladvisor_var_$traveladvisor_metass[$traveladvisor_a]", true);
        }
        ...
        $traveladvisor_no_gallery_class = "";
        if (empty($traveladvisor_var_tours_gallery_images_url)) {
            //$traveladvisor_no_gallery_class = "no-image";
        }
        ?>
        <div class="<?php echo $col_class; ?>">

            <div class="cs-list <?php echo $inv_class; ?> <?php echo esc_html($traveladvisor_no_gallery_class); ?>">
                ...
                <div class="cs-text">
                    <div class="cs-heading-section">
                        <div class="cs-post-title">
                            <h3><a href="<?php the_permalink(); ?>"><?php echo esc_html($traveladvisor_tours_title); ?></a></h3>
                            <ul>
                                <?php
                                $traveladvisor_labelss = isset($traveladvisor_labelss) ? $traveladvisor_labelss : array();
                                $traveladvisor_count = count($traveladvisor_labelss) - 1;
                                if (!empty($traveladvisor_aa)) {
                                    for ($traveladvisor_aa = 0; $traveladvisor_aa <= 0; $traveladvisor_aa ++) {
                                        ?>
                                        <li><?php
                                            if (!is_array($traveladvisor_labelss[$traveladvisor_aa])) {
                                                echo esc_html($traveladvisor_labelss[$traveladvisor_aa]);
                                            }
                                            ?><span class="cs-color"><?php
                                            if (is_array($traveladvisor_metass_values[$traveladvisor_aa])) {
                                                $traveladvisor_values_to_go = isset($traveladvisor_metass_values[$traveladvisor_aa]) ? $traveladvisor_metass_values[$traveladvisor_aa] : array();
                                                foreach ($traveladvisor_values_to_go as $val) {
                                                    $val = str_replace("-", " ", $val);

                                                    $val = ucfirst($val);
                                                    echo $val;
                                                    $traveladvisor_getted_field_value_sec = $traveladvisor_metass[$traveladvisor_aa + 1];
                                                    if (!empty($traveladvisor_getted_field_value_sec)) {
                                                        echo ",";
                                                    }
                                                }
                                            } else {
                                                $traveladvisor_getted_field_value = $traveladvisor_metass_values[$traveladvisor_aa];
                                                if (!is_array($traveladvisor_getted_field_value)) {
                                                    echo esc_html($traveladvisor_getted_field_value);
                                                }
                                            }
                                            ?></span></li>
                                        <?php
                                ...
                                ?>
                                <li><?php echo traveladvisor_var_theme_text_srt('traveladvisor_var_tour_duration');
                                ?><span class="cs-color"><?php echo esc_html($traveladvisor_var_tour_duration); ?></span></li>
                        ...
                        <div class="cs-price-box"> <em class="cs-bgcolor"><?php esc_html_e('Price from', 'cs-traveladvisor'); ?></em>

                            <strong><sup><?php echo esc_html($traveladvisor_var_currency); ?></sup><?php echo esc_html($traveladvisor_var_tours_price); ?>
                                <?php if (!$s_traveladvisor_tours_oldprice == '') { ?>
    ...
    if ($traveladvisor_var_tour_paging_filter_style == "pagination" && $traveladvisor_var_tour_item_per_page > 0) {
        $total_pages = '';
