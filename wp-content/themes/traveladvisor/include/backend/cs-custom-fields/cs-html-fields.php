...
if (!class_exists('traveladvisor_var_html_fields')) {
    ...
    class traveladvisor_var_html_fields extends traveladvisor_var_form_fields {
        ...
        public function traveladvisor_form_layout_render($params = '') {
            ...
            $traveladvisor_output .= '<img src="' . get_template_directory_uri() . '/assets/backend/images/no_sidebar.png"  alt="no_sidebar" />';
            ...
            $traveladvisor_output .= '<span class="ss">';
            $traveladvisor_output .= '<img src="' . get_template_directory_uri() . '/assets/backend/images/sidebar_right.png" alt="sidebar_right" />';
            $traveladvisor_output .= '</span>';
            ...
            $traveladvisor_output .= '<span class="ss">';
            $traveladvisor_output .= '<img src="' . get_template_directory_uri() . '/assets/backend/images/sidebar_left.png" alt="sidebar_left" />';
            $traveladvisor_output .= '</span>';
       ...
       public function traveladvisor_var_textarea_field($params = '') {
        ...
        public function traveladvisor_var_checkbox_field($params = '') {
           ...
           if ($id=='traveladvisor_var_autosidebar_checkbox'){
...
jQuery("#traveladvisor_autosidebar_hide").toggle();
	    ...
	    <label>' . esc_attr($name) . '</label>';
            ...
            $traveladvisor_var_output .= '<div class="thumb-secs"> <img src="' . esc_url($value) . '" id="traveladvisor_var_' . sanitize_html_class($id) . $traveladvisor_var_random_id . '_img" width="100" alt="secs" />';
            ...
            if (isset($fields_list) && is_array($fields_list)) {
                foreach ($fields_list as $field_array) {
                    if ($field_array['type'] == 'text') {
                        ...
                        $traveladvisor_var_output .= '<ul id="gal-sortable">';
                        $traveladvisor_var_output .= '<li class="ui-state-default" id="">';
                        $traveladvisor_var_output .= '<div class="thumb-secs"> <img src="' . esc_url($value) . '" id="traveladvisor_var_' . sanitize_html_class($id) . '_img" width="100" alt="thumb-secs" />';
                                ...
                                foreach ($gallery as $attach_url) {
                                    ...
                                    if ($attach_url != '') {
										...
										<li class="image" data-attachment_id="' . esc_attr($traveladvisor_var_gal_id) . '">
											...
											<div class="actions">
												<span><a href="javascript:traveladvisor_var_createpop(\'edit_track_form' . absint($traveladvisor_var_gal_id) . '\',\'filter\')"><i class="icon-edit3"></i></a></span>
												<span><a href="javascript:;" class="delete tips" data-tip="' .traveladvisor_var_theme_text_srt('traveladvisor_var_html_fields_delete_image'). '"><i class="icon-times"></i></a></span>
											</div>
