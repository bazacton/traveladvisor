...
if (!class_exists('traveladvisor_var_widget_data')) {
    ...
    class traveladvisor_var_widget_data {
        ...
        public function __construct() {
            ...
            add_action('wp_ajax_traveladvisor_widget_file_delete', array(__CLASS__, 'traveladvisor_widget_file_delete'));
        }
        ...
        public static function enqueue_admin_scripts($hook) {
            ...
            wp_enqueue_script('widget_data', get_template_directory_uri() . '/assets/backend/scripts/cs-widget-data.js', '', '', true);
        ...
        public static function export_settings_page() {
            ...
            <div class="widget-data cs-export-widget-settings">
                ...
                <div class="cs-export-wrapper">
                    ...
                    <div id="cs-widget-export-form">
                        <div class="title">
                            <h3><?php _e('Widget Setting Export', 'traveladvisor') ?></h3>
                            <span class="cs-select-butns">
                                <a class="select-all"><?php _e('Select All', 'traveladvisor') ?></a>
                                <a class="unselect-all"><?php _e('Un-Select All', 'traveladvisor') ?></a>
                            </span>
                            <div class="clear"></div>
                        </div>
                        <div class="sidebars">
                                        ...
                                        <div class="widgets">
                                            ...
                                            foreach ($widget_list as $widget) :
                                                ...
                                                <div class="import-form-row">
                                                    <input class="<?php echo traveladvisor_allow_special_char($sidebar_name == 'wp_inactive_widgets') ? 'inactive' : 'active'; ?> widget-checkbox" type="checkbox" name="<?php echo esc_attr($widget); ?>" id="<?php echo esc_attr('meta_' . $widget); ?>" />
            ...
            <?php
            $traveladvisor_output = ob_get_clean();
            ...
            <?php if (isset($_POST['file_name']) && $_POST['file_name'] != '') : ?>
                    ...
                    <div class="cs-import-wrapper">
                        ...
                        <div id="cs-import-widget-form">
                            ...
                            <div class="title">
                                ...
                                <span class="cs-select-butns">
                                    <a class="imp-select-all"><?php _e('Select All', 'traveladvisor') ?></a>
                                    <a class="imp-unselect-all"><?php _e('Un-Select All', 'traveladvisor') ?></a>
                                </span>
                                <div class="clear"></div>
                            </div>
                            <div class="sidebars">
                                            ...
                                            <div class="sidebar">
                                                ...
                                                <div class="widgets">
                                                    ...
                                                    foreach ($widget_list as $widget) :
                                                        ...
                                                        ?>
                                                        <div class="import-form-row">
                                                            <input class="<?php echo traveladvisor_allow_special_char($sidebar_name == 'wp_inactive_widgets') ? 'inactive' : 'active'; ?> widget-checkbox" type="checkbox" name="<?php echo esc_attr(printf('widgets[%s][%d]', $widget_type, $widget_type_index)); ?>" id="<?php echo esc_attr('meta_' . $widget); ?>" />
                ...
                <?php endif; ?>
                            ...
                            <p>
                                ...
                                <label for="clear-current"><?php _e('Clear Current Widgets Before Import', 'traveladvisor') ?></label><br/>
                                <span class="description"><?php _e('All active widgets will be moved to inactive', 'traveladvisor') ?></span>
                            </p>
                    ...
                    ?>
                    <p><?php _e('Put File URL that contains widget settings', 'traveladvisor') ?></p>
                    <p>
                        <input type="text" id="cs-widget-upload-file" />
                    </p>
                    <input type="button" id="widget-import-submit" class="button" value=<?php _e("Show Widget Settings", 'traveladvisor') ?> />
            <?php endif; ?>
        ...
        public static function export_widget_settings() {
            ...
            if (isset($_POST['action']) && $_POST['action'] == 'export_widget_settings') {
                $backup_url = wp_nonce_url('themes.php?page=traveladvisor_options_page');
                ...
                $traveladvisor_upload_dir = get_template_directory() . '/include/backend/cs-widgets/import/widgets-backup/';
                $traveladvisor_filename = trailingslashit($traveladvisor_upload_dir) . 'widget_' . (current_time('d-M-Y_H.i.s')) . '.json';

                $traveladvisor_widgets_file = self::parse_export_data($_POST);

                if (!$wp_filesystem->put_contents($traveladvisor_filename, $traveladvisor_widgets_file, FS_CHMOD_FILE)) {
                    echo __("Error saving file!", 'traveladvisor');
                } else {
                    echo __("Backup Generated.", 'traveladvisor');
                }
            }
            die;
        }

        public static function traveladvisor_widget_file_delete() {
            ...
            if (is_file($traveladvisor_filename)) {
                ...
                echo __("Error Deleting file!", 'traveladvisor');
            }
        ...
        public static function ajax_import_widget_data() {
            ...
            if (empty($wp_filesystem)) {
                traveladvisor_include_file(ABSPATH . '/wp-admin/includes/file.php');
                WP_Filesystem();
            }
         ...
         */
        public static function traveladvisor_import_widget_data( $filename = "" ) {
			...
			if ( $filename == "" ) {
				$traveladvisor_upload_dir = get_template_directory() . '/include/backend/cs-widgets/import/import-widgets/';

				$file_name = 'import-widgets.json';

				$import_file = trailingslashit($traveladvisor_upload_dir) . $file_name;
			} else {
            ...
            if (is_array($sidebar_data)) {
                ...
                echo '<p><strong>' . __('Widgets Imported Successfully.', 'traveladvisor') . '</strong><br />';
            } else {
                echo '<p><strong>' . __('Widgets data not Imported.', 'traveladvisor') . '</strong><br />';
            }
        }
...
$traveladvisor_var_widget_data = new traveladvisor_var_widget_data();
